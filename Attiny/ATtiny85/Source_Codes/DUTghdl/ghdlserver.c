 ...
 *
 * 1.July.2022 - Sumanto Kar - Added MapToHex() and Hex File Path Passing and 
 *             - Vatsal Patel  Processing mechanism delivering hex path directly
 *                             to the microcontroller C file
 ************************************************************************************
